              ...
              <div class="auth-box">
                <el-form :hide-required-asterisk='true' :model="form" label-width="100px" ref="ruleForm" :rules="rule"
                  ...
                  <el-form-item label="新邮箱" prop="email">
                    <el-input type='email' v-model="form.email" placeholder="请输入新邮箱">
                    </el-input>
                  </el-form-item>
                </el-form>
  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        rule: {
          email: [
            { required: true, validator: validatePassEmail, message: '请输入密码', trigger: 'blur' },
          ]
        }
      }
    },
      ...
      submit (formName) {
        ...
        this.$refs[formName].validate(async (valid) => {
          if (valid) {
            ...
            let data = await api.updateLoginEmail(opts)
            if (data.status === 0) {

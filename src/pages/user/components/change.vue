        ...
        <div class="wrapper">
          <div class="box page-part transaction">
            <div class="box-contain clearfix">
              ...
              <el-card
                v-if="
                  $store.state.productSetting.indexDisplay ||
                    $store.state.userInfo.accountType === 1
                "
                class="box-card"
                        ...
                        >
                          <el-form-item label="转账金额" prop="number">
                            <el-input
                              ...
                              placeholder="请输入转账金额"
                            >
                              <el-button @click="selectAll1" slot="append"
                                >全部</el-button
                              >
                            </el-input>
                        ...
                        >
                          <el-form-item label="转账金额" prop="number">
                            <el-input
                              ...
                              @change="getIntNumber2"
                              placeholder="请输入转账金额"
                            >
                              <el-button @click="selectAll2" slot="append"
                                >全部</el-button
                              >
                            </el-input>
                            <span class="red">转账金额仅支持整数</span>
              ...
              <el-card
                v-if="
                  $store.state.productSetting.futuresDisplay ||
                    $store.state.userInfo.accountType === 1
                "
                class="box-card"
                style="margin-top:20px;"
                        ...
                        >
                          <el-form-item label="转账金额" prop="number">
                            <el-input
                              ...
                              @change="getIntNumber3"
                              placeholder="请输入转账金额"
                            >
                              <el-button @click="selectAll3" slot="append"
                                >全部</el-button
                              >
                            </el-input>
                            <span class="red">转账金额仅支持整数</span>
                        ...
                        >
                          <el-form-item label="转账金额" prop="number">
                            <el-input
                              ...
                              @change="getIntNumber4"
                              placeholder="请输入转账金额"
                            >
                              <el-button @click="selectAll4" slot="append"
                                >全部</el-button
                              >
                            </el-input>
                            <span class="red">转账金额仅支持整数</span>
...
export default {
  ...
  methods: {
    ...
    getIntNumber4() {
     ...
     getIntNumber6() {
      if (this.form.account6 >= this.$store.state.userInfo.enableHmt) {
        this.form.account6 = this.$store.state.userInfo.enableHmt;
      }
